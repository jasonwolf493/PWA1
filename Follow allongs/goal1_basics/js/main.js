...
console.log('------ strings ----------');
   ...
   // var helloWorld = "Hello World!";
    ...
    //console.log("example1: "+testString);

    //string w/ escape characters " \ "
    //var escapeChar = " hello \"hello\" hello";
...
console.log('------ numbers ----------');
    ...
    var adding = 10 + 12;
    var subtracting = 10 - 12;
    console.log("10 + 12 = "+adding+" | 10 - 12 = "+subtracting);
